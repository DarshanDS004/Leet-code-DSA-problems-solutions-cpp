<h2><a href="https://leetcode.com/problems/first-unique-even-element/?envType=problem-list-v2&envId=hash-table">4252. First Unique Even Element</a></h2><h3>Easy</h3><hr><p>You are given an integer array <code>nums</code>.</p>
